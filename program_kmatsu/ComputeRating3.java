...
public class ComputeRating3 {
	...
	public static void main(String[] args) {
		...
		// Initialize Players
		PlayerInfo[] players = new PlayerInfo[11]; // 10
		...
		players[8] = new PlayerInfo(8, "AlphaBeta3");
		players[9] = new PlayerInfo(9, "AB1");
		players[10] = new PlayerInfo(9, "AB2");

		// Initialize PlayLongs
		ArrayList<PlayLog> logs = new ArrayList<PlayLog>();
		int[][] results = {
			{ -1,  12,  14,   3,   0,   0,   0,   1,   0,   3,   0},
			{ 90,  -1,  48,  49,  26,  31,  12,  12,   1,  23,   1},
			{ 84,  53,  -1,  43,  22,  24,  15,  10,   0,  12,   1},
			{ 99,  49,  54,  -1,  14,  16,  10,  15,   0,  30,   1},
			{ 100, 76,  76,  89,  -1,  48,  25,  33,   1,  51,   3},
			{ 99,  74,  64,  82,  53,  -1,  37,  47,   4,  37,   1},
			{ 99,  74,  74,  75,  60,  68,  -1,  62,   2,  29,   1},
			{ 99,  75,  66,  73,  65,  55,  41,  -1,   0,  38,   1},
			{ 100, 100, 100, 100, 98,  96,  98,  98,  -1, 100,   0},
			{ 96,  81,  97,  76,  53,  56,  57,  65,   0,  -1,   0},
			{ 99, 100, 100, 100,  96,  98,  99,  98,   0,   0,  -1},
		};

		for (int p1 = 0; p1 < 11; p1++) { //10
