...
public class GameController3 {
  ...
  public GameController3(int gamecount) {
    Scanner scan = new Scanner(System.in);

    //Black Player
    int val = GetState.b_cpu[gamecount];
    if(val == 1)b_cpu = new RandomCPU(1, 1);
    else if(val == 2)b_cpu = new hyoukaCPU(1, 0, 0);
    else if(val == 3)b_cpu = new hyoukaCPU(1, 1, 0);
    else if(val == 4)b_cpu = new mcCPU(1, 1000);
    ...
    if(val == 1)w_cpu = new RandomCPU(-1, 1);
    else if(val == 2)w_cpu = new hyoukaCPU(-1, 0, 0);
    else if(val == 3)w_cpu = new hyoukaCPU(-1, 1, 0);
    else if(val == 4)w_cpu = new mcCPU(-1, 1000);
